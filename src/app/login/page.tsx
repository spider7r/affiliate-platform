    ...
    return (
        <div className="min-h-screen bg-[#050505] flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center relative overflow-hidden py-32 px-4">
                ...
                <div className="absolute top-1/4 -right-20 w-96 h-96 bg-[#00E676]/10 blur-[120px] rounded-full pointer-events-none" />
                <div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-purple-500/10 blur-[120px] rounded-full pointer-events-none" />
