...
export function LoginForm() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-[#050505] text-white relative overflow-hidden" style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
            {/* Background glow effects */}
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#00E676]/[0.03] rounded-full blur-[150px]" />
            <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[#00E676]/[0.02] rounded-full blur-[120px]" />

            <div className="w-full max-w-[440px] mx-4 relative z-10">
                {/* Logo */}
                <div className="text-center mb-8">
                    <Image src="/logo.png" alt="Tradal" width={180} height={54} className="mx-auto object-contain" />
                    <p className="text-[10px] text-[#00E676]/50 uppercase tracking-[0.35em] font-bold mt-3">Partner Program</p>
                </div>
                        ...
                        {success ? (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-[13px] text-white/30 mt-1.5 leading-relaxed">Check your email to verify your account,<br />then log in to start earning.</p>
                                </div>
                                <button
                                    onClick={() => { setIsRegister(false); setSuccess(false) }}
                                    className="text-[#00E676] font-bold text-[13px] hover:underline underline-offset-4"
                                >
                                    Proceed to Login →
                                </button>
                            </motion.div>
